...
class Group extends BaseController
{
    ...
    {
        $this->data['model'] = $this->groupModel->where('id',$id)->first();
    ...
    public function getAdd($id='')
    {
        ...
        {
            $this->data['model'] = $this->groupModel->getColumnTable();
        }
	...
	public function postAll()
	{
		...
		$result = $this->groupModel->select()->findAll();
    ...
    public function postSave()
    {
        ...
        $fields['group'] = $this->request->getPost('group');
            ...
            if (!empty($fields['id']))
            {
                if ($this->groupModel->update($fields['id'], $fields)) {
                    ...
                    $response['messages'] = $this->groupModel->validation->getErrors() ;
            ...
            {
                if ($this->groupModel->insert($fields)) {
	...
	public function postRemove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->groupModel->where('id', $id)->delete()) {
